...
import {
  ...
  Italic,
  Strikethrough,
  Code, // Used for inline code toggle
  List,
  ListOrdered,
  Heading1,
  // Removed: Heading2,
...
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem, // Keep DropdownMenuItem as it's used in JSX
  DropdownMenuTrigger,
...
const RichTextEditorToolbar: React.FC<RichTextEditorToolbarProps> = ({
  ...
  // Removed unused getActiveAlignment and handleAlignmentChange functions
