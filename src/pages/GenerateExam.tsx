...
import { ArrowLeft, Brain, Loader2, CheckCircle2, XCircle } from 'lucide-react';
...
const GenerateExam: React.FC = () => {
  ...
  const handleGenerateQuestions = async () => {
    ...
    try {
      ...
      queryClient.invalidateQueries({ queryKey: ['generatedQuestions'] }); // Invalidate cache for generated questions
    } catch (err: any) {
      dismissToast(toastId);
      ...
      {generatedQuestions && generatedQuestions.length > 0 && (
        <NotebookCard className="mt-6">
          <CardHeader>
            ...
            <CardDescription>Review the questions generated by the AI.</CardDescription>
          </CardHeader>
