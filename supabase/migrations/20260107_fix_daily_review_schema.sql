-- Fix function overload error and return type mismatch for get_daily_review_cards
-- We need to ensure the RETURNS TABLE matches EXACTLY what the frontend expects.

-- Drop all possible variations just in case
...
-- Recreate with strict signature matching CardItem interface
-- Frontend CardItem: id, term, definition, repetition_level, ease_factor, next_review_at, status, set_id, set_title
