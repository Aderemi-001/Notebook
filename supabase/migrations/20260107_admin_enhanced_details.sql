...
-- Includes Last Active, Verification Status, and Content Counts
...
BEGIN
    ...
    ORDER BY au.last_sign_in_at DESC NULLS LAST; -- Sort by last active interactions usually matter most
END;
$$;
